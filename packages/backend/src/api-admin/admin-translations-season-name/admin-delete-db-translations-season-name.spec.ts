...
describe('adminDeleteDbTranslationsSeasonName', () => {
  ...
  beforeEach(async () => {
    ...
    result = await adminDeleteDbTranslationsSeasonName(id);
  });

  test('calls getSqlQuery with the correct value', () =>
    expect(mockGetSqlQuery).toHaveBeenCalledWith(`${__dirname}/admin-delete-translations-season-name.sql`));
