...
import { BaseFormRegionSeasonFoodMap, IRegionSeasonFoodMapForm } from './BaseFormRegionSeasonFoodMap';
...
describe('<BaseFormRegionSeasonFoodMap />', () => {
